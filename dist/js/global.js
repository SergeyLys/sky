  ...
  var S2 = function () {
    ...
    S2.define('select2/selection/allowClear', ['jquery', '../keys'], function ($, KEYS) {
      ...
      AllowClear.prototype.bind = function (decorated, container, $container) {
        ...
        if (this.placeholder == null) {
          if (this.options.get('debug') && window.console && function () {}) {}
        }
      ...
      AjaxAdapter.prototype.query = function (params, callback) {
        ...
        function request() {
          var $request = options.transport(options, function (data) {
            ...
            if (self.options.get('debug') && window.console && function () {}) {
          ...
          for (var l = 0; l < languageNames.length; l++) {
            ...
            try {
              ...
              try {
                ...
                if (options.debug && window.console && function () {}) {}
    ...
    S2.define('select2/options', ['require', 'jquery', './defaults', './utils'], function (require, $, Defaults, Utils) {
      ...
      Options.prototype.fromElement = function ($e) {
        ...
        if ($e.data('select2Tags')) {
          if (this.options.debug && window.console && function () {}) {}
    ...
    S2.define('select2/core', ['jquery', './options', './utils', './keys'], function ($, Options, Utils, KEYS) {
      ...
      Select2.prototype.data = function () {
        if (this.options.get('debug') && arguments.length > 0 && window.console && function () {}) {}
        ...
        $.fn.select2 = function (options) {
          ...
          if ((typeof options === "undefined" ? "undefined" : _typeof(options)) === 'object') {
            ...
            this.each(function () {
              ...
              if (instance == null && window.console && function () {}) {}
...
},{"../modules/YTembed.js":4,"../modules/headerFunctions":6,"../modules/sliders.js":8}],13:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":14,"core-js/shim":307,"regenerator-runtime/runtime":309}],14:[function(require,module,exports){
'use strict';
